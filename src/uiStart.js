...
buttonFrame.style.background = 'linear-gradient(135deg, #6d6d6d 0%, #2b2b2b 50%, #6d6d6d 100%)';
...
startButton.style.background = 'linear-gradient(145deg, rgba(30,30,30,0.9) 0%, rgba(60,60,60,0.9) 100%)';
